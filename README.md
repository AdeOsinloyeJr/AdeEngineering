...
Demonstrates how to securely transfer a file from one EC2 instance to another using `scp`, configure Apache to serve the file, and verify results via a web browser.
> **Skills:** EC2 provisioning, SSH keys, Apache, SCP, Bash scripting  
